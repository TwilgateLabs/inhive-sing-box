...
func TestTLSFragment(t *testing.T) {
	...
	tlsConn := tls.Client(tf.NewConn(tcpConn, context.Background(), true, false, false, false, false, 0), &tls.Config{
...
func TestTLSRecordFragment(t *testing.T) {
	...
	tcpConn, err := net.Dial("tcp", "1.1.1.1:443")
	require.NoError(t, err)
	tlsConn := tls.Client(tf.NewConn(tcpConn, context.Background(), false, true, false, false, false, 0), &tls.Config{
		ServerName: "www.cloudflare.com",
	})
	require.NoError(t, tlsConn.Handshake())
}
...
func TestTLS2Fragment(t *testing.T) {
	...
	tcpConn, err := net.Dial("tcp", "1.1.1.1:443")
	require.NoError(t, err)
	tlsConn := tls.Client(tf.NewConn(tcpConn, context.Background(), true, true, false, false, false, 0), &tls.Config{
		ServerName: "www.cloudflare.com",
	})
	require.NoError(t, tlsConn.Handshake())
}
...
func TestTLSDisorder(t *testing.T) {
	...
	tcpConn, err := net.Dial("tcp", "1.1.1.1:443")
	require.NoError(t, err)
	tlsConn := tls.Client(tf.NewConn(tcpConn, context.Background(), false, false, true, false, false, 0), &tls.Config{
		ServerName: "www.cloudflare.com",
	})
	require.NoError(t, tlsConn.Handshake())
}
...
func TestTLSOOB(t *testing.T) {
	...
	tcpConn, err := net.Dial("tcp", "1.1.1.1:443")
	require.NoError(t, err)
	tlsConn := tls.Client(tf.NewConn(tcpConn, context.Background(), false, false, false, true, false, 0), &tls.Config{
		ServerName: "www.cloudflare.com",
	})
	_ = tlsConn.Handshake()
}
...
func TestTLSDisOOB(t *testing.T) {
	...
	tcpConn, err := net.Dial("tcp", "1.1.1.1:443")
	require.NoError(t, err)
	tlsConn := tls.Client(tf.NewConn(tcpConn, context.Background(), false, false, false, false, true, 0), &tls.Config{
		ServerName: "www.cloudflare.com",
	})
	_ = tlsConn.Handshake()
}
